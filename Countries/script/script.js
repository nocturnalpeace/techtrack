...
function normalizeCountry(myCountry) {
    ...
    myCountry.forEach(country => {
        let myCountry = {
            name: myCountry.name,
            region: myCountry.region
        }

        myArray.push(myCountry)
    });
...
console.log(normalizeCountry(countries))

normalizeCountries = countries.map(normalizeCountry).filter(country => country.region == "South Asia")
